...
// ViewModel types
interface CreateRoasteryFormState {
  name: string;
  city: string;
}

interface CreateRoasteryFormErrors {
  name?: string;
  city?: string;
  form?: string;
}

interface CreateRoasteryFormProps {
  accessToken: string;
...
export function CreateRoasteryForm({ accessToken, onSuccess }: CreateRoasteryFormProps) {
  ...
  const handleChange = useCallback(
    (field: keyof CreateRoasteryFormState) => (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  const handleBlur = useCallback(
    (field: keyof CreateRoasteryFormState) => () => {
