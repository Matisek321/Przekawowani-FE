    ...
    return (
      <div className="container mx-auto max-w-2xl px-4 py-8">
        <div className="flex flex-col items-center justify-center gap-4 py-12">
          ...
          <p className="text-muted-foreground">{isRedirecting ? "Przekierowuję..." : "Sprawdzanie dostępu..."}</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto max-w-2xl px-4 py-8">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Wprowadź dane nowej palarni kawy. Wszystkie pola są wymagane.</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <Alert>
            ...
            <AlertDescription>
              W wersji MVP nie można edytować ani usuwać palarni po jej utworzeniu. Upewnij się, że wprowadzone dane są
              poprawne.
            </AlertDescription>
          </Alert>

          {/* Roastery creation form */}
          {accessToken && <CreateRoasteryForm accessToken={accessToken} onSuccess={handleSuccess} />}
        </CardContent>
      </Card>
    </div>
  );
