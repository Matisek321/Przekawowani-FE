...
interface RateCoffeeFormErrors {
  main?: string;
  strength?: string;
  acidity?: string;
  aftertaste?: string;
 ...
 */
export function RateCoffeeForm({ coffeeId, accessToken, existingRating, onSuccess }: RateCoffeeFormProps) {
  const [values, setValues] = useState<RateCoffeeFormState>(() => getInitialState(existingRating));
