...
export interface CoffeeDetailVM {
  id: string;
  name: string;
  roasteryId: string;
  roasteryName?: string;
...
export interface UseCoffeeDetailResult {
...
function mapCoffeeDetailToVM(coffee: CoffeeDetailDto, roastery?: RoasteryDto): CoffeeDetailVM {
  return {
    id: coffee.id,
    name: coffee.name,
