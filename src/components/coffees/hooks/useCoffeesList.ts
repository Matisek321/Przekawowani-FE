...
import type { CoffeeListItemVM } from "../shared";

// ============================================================================
// Types
// ============================================================================

export interface CoffeesQueryState {
  page: number;
  pageSize: number;
}
...
export interface UseCoffeesListResult {
...
export function parseQueryFromUrl(): CoffeesQueryState {
  ...
  const pageSize =
    Number.isInteger(parsedPageSize) && parsedPageSize >= 1 && parsedPageSize <= 100 ? parsedPageSize : 100;
